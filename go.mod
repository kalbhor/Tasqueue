...
require (
	...
	github.com/francoispqt/gojay v0.0.0-20190228132548-90d953358b68 // indirect
	github.com/francoispqt/onelog v0.0.0-20190304085423-060a273d6185 // indirect
	...
	go.zerodha.tech/commons/go-logger v1.0.0 // indirect
